...
<body>
	...
	<section class="home_banner_area">
		<div class="banner_inner">
			<div class="container">
				<h2 style="margin-left: 500px;margin-top: -150px;color: #FDBB00">Select User for Registering</h2>
				<div class="banner_content" style="margin-left: 290px;margin-top: 40px">
				  <form id="Login" method="post" action="reg_database.php">
		<a class="primary_btn mr-20" href="signup1.php" style="width: 200px">Donor</a>
		<a class="primary_btn yellow_btn text-white" href="signup2.php" style="width: 200px">Organization</a>
    </div>
</div></div></div></div>
</div></div></div>
