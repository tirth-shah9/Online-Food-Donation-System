       ...
       <!--  <style>label.error{color:red;}
        ...
        function validate()
        {
            ...
            if(bdate1 == "")                       
            {
                ...
                $("#bdatererror").html("Please select your birthdate.");
                tmp++;
            }
            else
            {
...
<body>
	...
	<!--================ Home Banner Area =================<th colspan="2" style="font-size: 25px;">Registration Form</th>-->
	<section class="home_banner_area">

		<div class="banner_inner">
			<div class="container">
				<div class="banner_content">
					<p style="font-size: 50px;margin-left: 340px;margin-top: 150px"><u>REGISTRATION FORM</u></p>
				<form class="form" method="post" action="signupdb.php"  onsubmit="return validate()">
					<table style="margin-left:475px;background-color: #000000;border: 1px solid black;opacity: 0.5;width: 400px;font-style: Georgia;height: 450px;" align="text-center" > 
			<tr class="" style="margin-top: 70px">
...
<span style="color:#00c0ef; display: inline-block; position: relative;left: 25px"></span>
	<input type="text" style="width: 295px;margin-left:20px;margin-bottom:5px"  name="donor_name" id="donor_name" placeholder="Enter Full Name">
		<span id="nameerror" style="color: red; font-size: 15px"></span>
	</td></tr>
        	

        	<tr class=""><td style="text-align:right;vertical-align:middle;">
            Birthdate:</td><td align="left">
<span style="color:#00c0ef; display: inline-block; position: relative;left: 25px"></span>
              <input type="date" min="1950-01-01" max="2003-12-31" style="width: 295px;margin-left:20px;margin-bottom:5px"  name="donor_birthdate" id="donor_birthdate" placeholder="Enter Birthdate">
<span id="bdateerror" style="color: red; font-size: 15px"></span>
          </td></tr>
        	
    
    		<div class="form-group"><tr><td style="text-align:right;vertical-align:middle;">
    Gender: </td><td align="left" class="container rdoG">
<span style="color:#00c0ef; display: inline-block; position: relative;left: 25px"></span>
    	<input style="margin-bottom: 10px;margin-left: 20px;" type="radio" name="donor_gender" id="donor_gender"  value="male">Male
    <input style="margin-left: 15px;" type="radio"  name="donor_gender" id="donor_gender" placeholder="Select Gender"  value="female">Female
    <input style="margin-left: 15px;" type="radio"  name="donor_gender" id="donor_gender" placeholder="Select Gender"  value=other>Other</td></tr>
...
<span style="color:#00c0ef; display: inline-block; position: relative;left: 25px"></span>
            <input type="text" style="width:295px;margin-left:20px;margin-bottom:5px"  name="donor_phone" id="donor_phone" placeholder="Enter Mobile No">
...
<span style="color:#00c0ef; display: inline-block; position: relative;left: 25px"></span>
            	<textarea  style="width:295px;margin-left:20px;" rows="2" name="donor_address" id="donor_address" placeholder="Enter Address" rows="1" cols="18"></textarea>
...
<span style="color:#00c0ef; display: inline-block; position: relative;left: 25px"></span>
            	<input type="email" style="width: 295px;margin-left:20px;margin-bottom:5px"  name="donor_email" id="donor_email" placeholder="Enter Email" >
...
<span style="color:#00c0ef; display: inline-block; position: relative;left: 25px"></span>
           	<input type="password" style="width:295px;margin-left:20px;margin-bottom:5px" name="donor_password" id="donor_password" placeholder="Enter password">
<span id="passworderror" style="color: red; font-size: 15px"></span>
           </td></tr>

        

        <tr><center><td colspan="2" align="left">
        <button type="submit" style="width: 175px;margin-left: 20px" class="btn btn-primary" id="submit" name="submit">Submit</button>
        <button type="reset" class="btn btn-primary" style="width: 175px;" value="Reset">Reset</button></td></center></tr>
